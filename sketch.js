...
function setup(){
    ...
    chaoinvisivel.visible = false
        ...
        pontos = 0
           ...
           restart = createSprite(width/600*300,height/200*100)
           restart .addImage("restart.png", restartimagem)
           restart.scale = 0.5

           gameover = createSprite (width/600*300,height/200*90)
...
function draw(){
    background ("#A9A9A9")
    fill("white")
    text("pontos:"+pontos,width/600*500,height/600*250)
...
function nuvemcriar(){
if (frameCount%100 ==0){
nuvem = createSprite (width/600*600,random(height/600*260,height/600*220),width/600*40,height/600*10)
nuvem.addImage("cloud.png",nuvemimagem)
nuvem.velocityX = nuvem.velocityX -2 -((pontos*3)/100)
nuvem.scale = random(0.6,0.9)
